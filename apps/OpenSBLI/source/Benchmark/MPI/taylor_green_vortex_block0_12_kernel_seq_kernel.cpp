    ...
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          taylor_green_vortex_block0_12_kernel(  (double *)p_a[0]+ i*1*1, (double *)p_a[1]+ i*1*1, (double *)p_a[2]+ i*1*1,
           ...
           (double *)p_a[15]+ i*1*1, (double *)p_a[16]+ i*1*1, (double *)p_a[17]+ i*1*1, (double *)p_a[18]+ i*1*1,
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        taylor_green_vortex_block0_12_kernel(  (double *)p_a[0], (double *)p_a[1], (double *)p_a[2],
           ...
           (double *)p_a[15], (double *)p_a[16], (double *)p_a[17], (double *)p_a[18],
