...
//user function
inline void taylor_green_vortex_block0_7_kernel(const double *u1 , double *wk4)
{
...
void ops_par_loop_taylor_green_vortex_block0_7_kernel(char const *name, ops_block block, int dim, int* range,
 ops_arg arg0, ops_arg arg1) {
  ...
  #endif //OPS_MPI
  #ifdef OPS_DEBUG
  ops_register_args(args, "taylor_green_vortex_block0_7_kernel");
  #endif
    ...
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          taylor_green_vortex_block0_7_kernel(  (double *)p_a[0]+ i*1*1, (double *)p_a[1]+ i*1*1 );
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        taylor_green_vortex_block0_7_kernel(  (double *)p_a[0], (double *)p_a[1] );
