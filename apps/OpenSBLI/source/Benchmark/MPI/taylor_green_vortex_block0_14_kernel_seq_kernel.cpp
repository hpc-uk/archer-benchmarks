...
//user function
inline void taylor_green_vortex_block0_14_kernel(const double *wk11 , const double *wk12 , const double *wk10 , const double *wk9 , const double *wk13 , double *rhou1_old , double *rhou2_old , double *rhou0_old , double *rho_old , double *rhoE_old , const double *rkold)
{
...
void ops_par_loop_taylor_green_vortex_block0_14_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg8, ops_arg arg9, ops_arg arg10) {
  ...
  #endif //OPS_MPI
  #ifdef OPS_DEBUG
  ops_register_args(args, "taylor_green_vortex_block0_14_kernel");
  #endif
    ...
    for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
      ...
      for( n_x=start[0]; n_x<start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x+=SIMD_VEC ) {
        ...
        for ( int i=0; i<SIMD_VEC; i++ ){
          taylor_green_vortex_block0_14_kernel(  (double *)p_a[0]+ i*1*1, (double *)p_a[1]+ i*1*1, (double *)p_a[2]+ i*1*1,
           (double *)p_a[3]+ i*1*1, (double *)p_a[4]+ i*1*1, (double *)p_a[5]+ i*1*1, (double *)p_a[6]+ i*1*1,
           (double *)p_a[7]+ i*1*1, (double *)p_a[8]+ i*1*1, (double *)p_a[9]+ i*1*1, (double *)p_a[10] );
      ...
      for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
        ...
        taylor_green_vortex_block0_14_kernel(  (double *)p_a[0], (double *)p_a[1], (double *)p_a[2],
