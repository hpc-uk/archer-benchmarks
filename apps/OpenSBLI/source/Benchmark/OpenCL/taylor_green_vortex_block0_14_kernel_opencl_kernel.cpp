...
static bool isbuilt_taylor_green_vortex_block0_14_kernel = false;

void buildOpenCLKernels_taylor_green_vortex_block0_14_kernel(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9) {

  //int ocl_fma = OCL_FMA;
  if(!isbuilt_taylor_green_vortex_block0_14_kernel) {
    buildOpenCLKernels();
    //clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char* source_filename[1] = {(char*)"./OpenCL/taylor_green_vortex_block0_14_kernel.cl"};
    ...
    printf("Compiling taylor_green_vortex_block0_14_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_taylor_green_vortex_block0_14_kernel=%d  -Dydim0_taylor_green_vortex_block0_14_kernel=%d  -Dxdim1_taylor_green_vortex_block0_14_kernel=%d  -Dydim1_taylor_green_vortex_block0_14_kernel=%d  -Dxdim2_taylor_green_vortex_block0_14_kernel=%d  -Dydim2_taylor_green_vortex_block0_14_kernel=%d  -Dxdim3_taylor_green_vortex_block0_14_kernel=%d  -Dydim3_taylor_green_vortex_block0_14_kernel=%d  -Dxdim4_taylor_green_vortex_block0_14_kernel=%d  -Dydim4_taylor_green_vortex_block0_14_kernel=%d  -Dxdim5_taylor_green_vortex_block0_14_kernel=%d  -Dydim5_taylor_green_vortex_block0_14_kernel=%d  -Dxdim6_taylor_green_vortex_block0_14_kernel=%d  -Dydim6_taylor_green_vortex_block0_14_kernel=%d  -Dxdim7_taylor_green_vortex_block0_14_kernel=%d  -Dydim7_taylor_green_vortex_block0_14_kernel=%d  -Dxdim8_taylor_green_vortex_block0_14_kernel=%d  -Dydim8_taylor_green_vortex_block0_14_kernel=%d  -Dxdim9_taylor_green_vortex_block0_14_kernel=%d  -Dydim9_taylor_green_vortex_block0_14_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9);
        else
      ...
      printf("compiling taylor_green_vortex_block0_14_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[14] = clCreateKernel(OPS_opencl_core.program, "ops_taylor_green_vortex_block0_14_kernel", &ret);
    clSafeCall( ret );

    isbuilt_taylor_green_vortex_block0_14_kernel = true;
  }
...
void ops_par_loop_taylor_green_vortex_block0_14_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg9, ops_arg arg10) {
  ...
  buildOpenCLKernels_taylor_green_vortex_block0_14_kernel(
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 10, sizeof(cl_double), (void*) arg10.data ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 11, sizeof(cl_double), (void*) &deltat ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 12, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 13, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 14, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 15, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 16, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 17, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 18, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 19, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 20, sizeof(cl_int), (void*) &base8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 21, sizeof(cl_int), (void*) &base9 ));
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[14], 24, sizeof(cl_int), (void*) &z_size ));
