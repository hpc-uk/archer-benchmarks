...
void buildOpenCLKernels_taylor_green_vortex_block0_13_kernel(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3, int xdim4, int ydim4, int xdim5, int ydim5, int xdim6, int ydim6, int xdim7, int ydim7, int xdim8, int ydim8, int xdim9, int ydim9, int xdim10, int ydim10, int xdim11, int ydim11, int xdim12, int ydim12, int xdim13, int ydim13, int xdim14, int ydim14) {
  ...
  if(!isbuilt_taylor_green_vortex_block0_13_kernel) {
    ...
    printf("Compiling taylor_green_vortex_block0_13_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_taylor_green_vortex_block0_13_kernel=%d  -Dydim0_taylor_green_vortex_block0_13_kernel=%d  -Dxdim1_taylor_green_vortex_block0_13_kernel=%d  -Dydim1_taylor_green_vortex_block0_13_kernel=%d  -Dxdim2_taylor_green_vortex_block0_13_kernel=%d  -Dydim2_taylor_green_vortex_block0_13_kernel=%d  -Dxdim3_taylor_green_vortex_block0_13_kernel=%d  -Dydim3_taylor_green_vortex_block0_13_kernel=%d  -Dxdim4_taylor_green_vortex_block0_13_kernel=%d  -Dydim4_taylor_green_vortex_block0_13_kernel=%d  -Dxdim5_taylor_green_vortex_block0_13_kernel=%d  -Dydim5_taylor_green_vortex_block0_13_kernel=%d  -Dxdim6_taylor_green_vortex_block0_13_kernel=%d  -Dydim6_taylor_green_vortex_block0_13_kernel=%d  -Dxdim7_taylor_green_vortex_block0_13_kernel=%d  -Dydim7_taylor_green_vortex_block0_13_kernel=%d  -Dxdim8_taylor_green_vortex_block0_13_kernel=%d  -Dydim8_taylor_green_vortex_block0_13_kernel=%d  -Dxdim9_taylor_green_vortex_block0_13_kernel=%d  -Dydim9_taylor_green_vortex_block0_13_kernel=%d  -Dxdim10_taylor_green_vortex_block0_13_kernel=%d  -Dydim10_taylor_green_vortex_block0_13_kernel=%d  -Dxdim11_taylor_green_vortex_block0_13_kernel=%d  -Dydim11_taylor_green_vortex_block0_13_kernel=%d  -Dxdim12_taylor_green_vortex_block0_13_kernel=%d  -Dydim12_taylor_green_vortex_block0_13_kernel=%d  -Dxdim13_taylor_green_vortex_block0_13_kernel=%d  -Dydim13_taylor_green_vortex_block0_13_kernel=%d  -Dxdim14_taylor_green_vortex_block0_13_kernel=%d  -Dydim14_taylor_green_vortex_block0_13_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3,xdim4,ydim4,xdim5,ydim5,xdim6,ydim6,xdim7,ydim7,xdim8,ydim8,xdim9,ydim9,xdim10,ydim10,xdim11,ydim11,xdim12,ydim12,xdim13,ydim13,xdim14,ydim14);
        else
      ...
      printf("compiling taylor_green_vortex_block0_13_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[13] = clCreateKernel(OPS_opencl_core.program, "ops_taylor_green_vortex_block0_13_kernel", &ret);
    clSafeCall( ret );

    isbuilt_taylor_green_vortex_block0_13_kernel = true;
  }
...
void ops_par_loop_taylor_green_vortex_block0_13_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg14, ops_arg arg15) {
  ...
  buildOpenCLKernels_taylor_green_vortex_block0_13_kernel(
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 8, sizeof(cl_mem), (void*) &arg8.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 9, sizeof(cl_mem), (void*) &arg9.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 10, sizeof(cl_mem), (void*) &arg10.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 11, sizeof(cl_mem), (void*) &arg11.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 12, sizeof(cl_mem), (void*) &arg12.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 13, sizeof(cl_mem), (void*) &arg13.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 14, sizeof(cl_mem), (void*) &arg14.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 15, sizeof(cl_double), (void*) arg15.data ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 16, sizeof(cl_double), (void*) &deltat ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 17, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 18, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 19, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 20, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 21, sizeof(cl_int), (void*) &base4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 22, sizeof(cl_int), (void*) &base5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 23, sizeof(cl_int), (void*) &base6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 24, sizeof(cl_int), (void*) &base7 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 25, sizeof(cl_int), (void*) &base8 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 26, sizeof(cl_int), (void*) &base9 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 27, sizeof(cl_int), (void*) &base10 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 28, sizeof(cl_int), (void*) &base11 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 29, sizeof(cl_int), (void*) &base12 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 30, sizeof(cl_int), (void*) &base13 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 31, sizeof(cl_int), (void*) &base14 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 32, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 33, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[13], 34, sizeof(cl_int), (void*) &z_size ));
