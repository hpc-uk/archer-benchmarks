...
static bool isbuilt_taylor_green_vortex_block0_18_kernel = false;

void buildOpenCLKernels_taylor_green_vortex_block0_18_kernel(int xdim0, int ydim0, int xdim1, int ydim1, int xdim2, int ydim2, int xdim3, int ydim3) {

  //int ocl_fma = OCL_FMA;
  if(!isbuilt_taylor_green_vortex_block0_18_kernel) {
    buildOpenCLKernels();
    //clSafeCall( clUnloadCompiler() );
    cl_int ret;
    char* source_filename[1] = {(char*)"./OpenCL/taylor_green_vortex_block0_18_kernel.cl"};
    ...
    printf("Compiling taylor_green_vortex_block0_18_kernel %d source -- start \n",OCL_FMA);
      ...
      if (pPath!=NULL)
        if(OCL_FMA)
          sprintf(buildOpts,"-cl-mad-enable -DOCL_FMA -I%s/c/include -DOPS_WARPSIZE=%d  -Dxdim0_taylor_green_vortex_block0_18_kernel=%d  -Dydim0_taylor_green_vortex_block0_18_kernel=%d  -Dxdim1_taylor_green_vortex_block0_18_kernel=%d  -Dydim1_taylor_green_vortex_block0_18_kernel=%d  -Dxdim2_taylor_green_vortex_block0_18_kernel=%d  -Dydim2_taylor_green_vortex_block0_18_kernel=%d  -Dxdim3_taylor_green_vortex_block0_18_kernel=%d  -Dydim3_taylor_green_vortex_block0_18_kernel=%d ", pPath, 32,xdim0,ydim0,xdim1,ydim1,xdim2,ydim2,xdim3,ydim3);
        else
      ...
      printf("compiling taylor_green_vortex_block0_18_kernel -- done\n");

    // Create the OpenCL kernel
    OPS_opencl_core.kernel[16] = clCreateKernel(OPS_opencl_core.program, "ops_taylor_green_vortex_block0_18_kernel", &ret);
    clSafeCall( ret );

    isbuilt_taylor_green_vortex_block0_18_kernel = true;
  }
...
void ops_par_loop_taylor_green_vortex_block0_18_kernel(char const *name, ops_block block, int dim, int* range,
 ...
 ops_arg arg4, ops_arg arg5, ops_arg arg6) {
  ...
  buildOpenCLKernels_taylor_green_vortex_block0_18_kernel(
  ...
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 5, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 6, sizeof(cl_int), (void*) &r_bytes4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 7, sizeof(cl_mem), (void*) &arg5.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 8, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 9, sizeof(cl_int), (void*) &r_bytes5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 10, sizeof(cl_mem), (void*) &arg6.data_d ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 11, nthread*sizeof(double), NULL));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 12, sizeof(cl_int), (void*) &r_bytes6 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 13, sizeof(cl_double), (void*) &rinv1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 14, sizeof(cl_double), (void*) &rinv4 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 15, sizeof(cl_double), (void*) &rinv5 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 16, sizeof(cl_double), (void*) &rc0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 17, sizeof(cl_double), (void*) &rc2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 18, sizeof(cl_double), (void*) &rc3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 19, sizeof(cl_int), (void*) &base0 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 20, sizeof(cl_int), (void*) &base1 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 21, sizeof(cl_int), (void*) &base2 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 22, sizeof(cl_int), (void*) &base3 ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 23, sizeof(cl_int), (void*) &x_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 24, sizeof(cl_int), (void*) &y_size ));
  clSafeCall( clSetKernelArg(OPS_opencl_core.kernel[16], 25, sizeof(cl_int), (void*) &z_size ));
