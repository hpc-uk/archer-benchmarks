      ...
      for ( int n_y=start[1]; n_y<end[1]; n_y++ ){
        for ( int n_x=start[0]; n_x<start[0]+(end[0]-start[0])/SIMD_VEC; n_x++ ){
          ...
          for ( int i=0; i<SIMD_VEC; i++ ){
            taylor_green_vortex_block0_15_kernel(  (const double * )p_a[0]+ i*1*1, (const double * )p_a[1]+ i*1*1, (const double * )p_a[2]+ i*1*1,
        ...
        for ( int n_x=start[0]+((end[0]-start[0])/SIMD_VEC)*SIMD_VEC; n_x<end[0]; n_x++ ){
          ...
          taylor_green_vortex_block0_15_kernel(  (const double * )p_a[0], (const double * )p_a[1], (const double * )p_a[2],
