...
BENCHDIR=/work/z01/z01/aturner/benchmark/ARCHER/GROMACS/GromacsARCHERBench_master
...
WORKDIR=/work/z01/z01/aturner/benchmark/ARCHER/GROMACS/gromacs_scratch
...
date
aprun -n $tasks -N  $[$CHIPS_PER_NODE*$TASKS_PER_CHIP] $MDRUN -s $TPRFILE -deffnm $casename -ntomp $OMP_NUM_THREADS
date
